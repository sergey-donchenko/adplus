  ...
  render: function() {
    return (
      React.createElement("div", {className: "Avatar"}, 
        React.createElement("img", {className: "Avatar-img", src: this.props.imgSrc, alt: ""})
      )
    )
  }
});
  ...
  render: function() {
    return (
      React.createElement("div", {className: "Profile"}, 
        React.createElement("h2", {className: "Profile-title"}, this.props.username), 
        React.createElement("div", {className: "Profile-body"}, 
          React.createElement(Avatar, {imgSrc: this.props.avatar}), 
          React.createElement(Bio, {text: this.props.bio})
        )
      )
    )
  }
});
},{"./Avatar.jsx":2,"./Bio.jsx":3,"react":160}],5:[function(require,module,exports){
